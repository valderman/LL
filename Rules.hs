...
withRule b = Deriv ["Θ"] [("",meta "Γ"),("z",meta "A" :&: meta "B")] (With "x" b 1 (What "a"))
...
forallRule = Deriv ["Θ"] [gamma,("z",Forall "α" (Meta True "A" [var 0]))] $ TApp "x" 1 (meta "B") whatA
existRule = Deriv ["Θ"] [gamma,("z",Exists "α" (Meta True "A" [var 0]))] $ TUnpack "x" 1 whatA
offerRule = Deriv ["Θ"] [("",Bang (meta "Γ")),("z",Quest (meta "A"))] $ Offer "x" 1 whatA
demandRule = Deriv ["Θ"] [gamma,("z",Bang (meta "A"))] $ Demand "x" dum 1 whatA
