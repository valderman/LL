...
chanRedRules = fts 
   [("bit write", Deriv ["Θ"] [gamma,("z",neg (tA :⊕: tB))] $ Cut "w" "_w" (tA :⊕: tB) 1 (With "x" True 0 whatA) (Channel dum))
   ,("bit read" , Deriv ["Θ"] [("z",tA),gamma] $ Cut "x" "_x" (tA :⊕: tB) 1 (ChanPlus True tA tB)  (Plus "x" "y" 0 whatA whatB))
